...
setup(
    ...
    description='Plugin to use some of the Tomography tools from IMOD in Scipion',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-imod',  # Optional
